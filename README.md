...
| Source  | Notes | Featured Images |
| :------------ |:---------------:|:---------------:|
[Understanding and Coding the Self-Attention Mechanism of Large Language Models From Scratch](https://sebastianraschka.com/blog/2023/self-attention-from-scratch.html)  <br>[Understanding and Coding Self-Attention, Multi-Head Attention, Cross-Attention, and Causal-Attention in LLMs](https://magazine.sebastianraschka.com/p/understanding-and-coding-self-attention)    | Coding self-attention and cross-attention from scratch.  | ![alt text](https://github.com/sianjin/Machine-Learning-Online-Resource-Fundamentals/blob/main/images/transformers/self_attention_from_scratch_1_sebastianraschka.png) ![alt text](https://github.com/sianjin/Machine-Learning-Online-Resource-Fundamentals/blob/main/images/transformers/self_attention_from_scratch_2_sebastianraschka.png) ![alt text](https://github.com/sianjin/Machine-Learning-Online-Resource-Fundamentals/blob/main/images/transformers/self_attention_from_scratch_3_sebastianraschka.png)|
